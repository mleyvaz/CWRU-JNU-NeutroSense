...
IN_DOC  = os.path.join(OUT, "CWRU_JNU_NeutroSense_INGENIUS_v6.docx")
OUT_DOC = os.path.join(OUT, "CWRU_JNU_NeutroSense_INGENIUS_v6_FINAL.docx")
...
FIGURES = {
    ...
    "Fig3_FBands_v4.png":               ("Fig3_FBands_v4.png",               16.0),
    "Fig4_DecileError_v4.png":          ("Fig4_DecileError_v4.png",          16.0),
    "Fig5_AbstentionCurves_v4.png":     ("Fig5_AbstentionCurves_v4.png",     16.0),
}
